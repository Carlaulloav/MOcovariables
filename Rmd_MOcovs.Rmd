...
P(>|Z|) = mas alto que 0,05, por lo tanto, no son significativos, por lo tanto, no hay diferncias en ocupación por "Ecosistema" (inferencia)
...
```
preguntas:
- que hacemos con ecosistema (juntar tundra con matorral?)
- como evaluar estación o temporada, 4 meses duración desde la instalación hasta retiro de CT.
